...
function AppMenu() {
  return (
    <ul className="nav flex-column">
      ...
      <Link href="/ch01_component_declaration/Exam01ClassTypeComponent"><a className="nav-link text-warning">클래스형 컴포넌트</a></Link>
      <Link href="/ch01_component_declaration/Exam02FunTypeComponent"><a className="nav-link text-warning">함수형 컴포넌트</a></Link>
      </li>
      <li className="nav-item mt-3">
